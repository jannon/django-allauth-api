...
DEFAULTS = {
    ...
    'DRF_SEND_EMAIL_CONFIRMATION_PERMISSIONS': ('rest_framework.permissions.IsAuthenticated',),
    'DRF_PASSWORD_VIEW_PERMISSIONS': ('rest_framework.permissions.IsAuthenticated',),
    'DRF_PASSWORD_RESET_PERMISSIONS': ('rest_framework.permissions.AllowAny',),
...
IMPORT_STRINGS = (
    ...
    'DRF_SEND_EMAIL_CONFIRMATION_PERMISSIONS',
    'DRF_PASSWORD_VIEW_PERMISSIONS',
    'DRF_PASSWORD_RESET_PERMISSIONS',
